            ...
            {choose && (
              <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                <div className="sticky top-0 overflow-hidden ">
                  <div className="relative flex justify-center items-center lg:h-96">
                    <a
                      className="absolute left-0 transform md:-ml-0  top-1/2 translate-1/2"
                      href="#"
                    >
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="w-5 h-5 text-blue-500 bi font-bold  bi-chevron-left dark:text-blue-200"
                        viewBox="0 0 16 16"
                      >
                        <path
                          fill-rule="evenodd"
                    ...
                    <div className="w-full h-56 justify-center items-center px-8 rounded-md">
                      <img
              ...
              <div className="px-0 lg:pl-20">
                ...
                <div className=" w-full mb-6">
                  <h2 className="mb-2 text-lg font-bold text-gray-700 dark:text-gray-400">
                    Spécification de l'appartement :
                  </h2>

...
export default function Alouer() {
  ...
  const get_all_maison_apparte = () => {
    ...
    Axios.get(
      `${import.meta.env.VITE_BASE_URL}get_all_maison_apparte2`,
      {}
    ).then((response) => {
      if (response.data[0]) {
    ...
    <div>
      ...
      <div className="w-full px-4 flex flex-col">
        ...
        <div className="w-full flex justify-center items-center mt-10">
          {/* <div className="flex flex-wrap w-full justify-center gap-2 items-center px-0 md:px-32 family"> */}
              ...
              <>
                <div className="flex justify-center items-center w-full mb-8 mt-8">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    <img
                      src={`${import.meta.env.VITE_BASE_URL}uploads/gs.png`}
                      alt=""
                    />
